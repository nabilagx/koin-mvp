...
export default async function LoginPage({
  ...
  return (
    <AuthFrame title="Masuk ke KOIN" subtitle="Akses dashboard admin, parent, child, atau canteen sesuai role akun Anda.">
      ...
      <form action={loginAction} className="mt-5 space-y-4">
        ...
        <SubmitButton className="btn-primary w-full" pendingText="Masuk...">Login</SubmitButton>
      </form>
